    ...
    return (
      <>
        ...
        {this.state.checkboxes.map((elem) => {
          ...
          return (
            <>
              <input type="checkbox" label={elem.name} key={elem.id} id={elem.id} checked={elem.selected} onChange={this.onChangeRoiIndi} />

              <i className="fa fa-square" style={{ color: strCol }}>
                {' '}
              </i>
            </>
          );
