...
class UiOpenMenu extends React.Component {
    ...
    render() {
        ...
        const jsxOpenMenu = <>
            {/*<ButtonsDemo/>*/}
            <UIButton icon="file" rounded handler={evt => this.onButtonLocalFile(evt)}/>
            <UIButton icon="folder" rounded handler={evt => this.onButtonLocalFile(evt)}/>
            <UIButton icon="link" rounded handler={this.onModalUrlShow}/>
            {(NEED_DEMO_MENU) ?
                <UIButton icon="grid" rounded handler={this.onModalDemoOpenShow}/>
                :
                null}
            <UIButton icon="link" rounded handler={this.onModalGoogleShow}/>
