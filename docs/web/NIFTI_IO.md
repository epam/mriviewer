...
...       vox_offset (float32) — where voxel data starts
...
- Backward compatible: files saved by the app *before* this fix (`vox_offset = 348`)
...
- RGB and 32-bit (and other non 8/16-bit) datatypes are not supported.
