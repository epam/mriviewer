...
export default class ActiveVolume {
  ...
  */
  createGeoSphere() {
    ...
    const xScale = this.m_sphereRadius.x * this.m_xWorldBox / dimMin;
    const yScale = this.m_sphereRadius.y * this.m_yWorldBox / dimMin;
    const zScale = this.m_sphereRadius.z * this.m_zWorldBox / dimMin;
