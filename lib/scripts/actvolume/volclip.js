...
export default class VolumeClipper {
  ...
  */
  ...
  static clipVolumeByNonConvexGeo(volTexSrc, xDim, yDim, zDim, volTexDst, geo, buildMask) {
    let i, i4;
    ...
    // console.log(`clipVolumeByNonConvexGeo. Centroid = ${vCentroid.x}, ${vCentroid.y}, ${vCentroid.z}`);
    // console.log(`clipVolumeByNonConvexGeo. buildMask = ${buildMask}`);
