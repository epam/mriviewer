...
* @module app/scripts/graphics2d/canvastext
*/
...
export default class CanvasText {
  ...
  */
  drawText(strTextToRender, strTextColor) {
    ...
    // this.m_textHeight = 1.1 * Math.floor(this.m_ctx.measureText('W').width);

    // set canvas size to desired dimension
    this.m_canvas.width = THREE.Math.nextPowerOfTwo(this.m_textWidth);
    this.m_canvas.height = THREE.Math.nextPowerOfTwo(this.m_textHeight);
