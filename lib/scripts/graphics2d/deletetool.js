...
export default class DeleteTool {
   ...
   */
  onMouseDown(x, y, distancesV, anglesA, rectR, areaD, vertexesD, vertexesA, vertexesR, vertexesAr, areaLL, vertexesArr,
    arr) {
   ...
   * @param (float) y - mouse y coordinate
   */
  onMouseMove(x, y, zoom, distancesV, anglesA, rectsR, areaD) {
