...
/**
* Mesh with 2d text
* @module app/scripts/graphics2d/mesh2d
*/
  ...
  */
  updateText(xc, yc, letterHeight, xAlign, yAlign, strTextBackColor, strTextColor) {
    ...
    if (this.m_material === null) {
      ...
      const xMin = MeshText2D.getXMin(xc, xAlign, psx);
      const xMax = MeshText2D.getXMax(xc, xAlign, psx);
      const yMin = MeshText2D.getYMin(yc, yAlign, psy);
      const yMax = MeshText2D.getYMax(yc, yAlign, psy);

      const Z_COORD_TEXT = 0.05;
      const v0 = new THREE.Vector3(xMin, yMin, Z_COORD_TEXT);
      const v1 = new THREE.Vector3(xMax, yMin, Z_COORD_TEXT);
      const v2 = new THREE.Vector3(xMin, yMax, Z_COORD_TEXT);
      const v3 = new THREE.Vector3(xMax, yMax, Z_COORD_TEXT);
      ...
      this.m_matTextureBox.create(boxTexture, (mat) => {
        ...
        const vb0 = new THREE.Vector3(xMin, yMin, Z_COORD_BOX);
        const vb1 = new THREE.Vector3(xMax, yMin, Z_COORD_BOX);
        const vb2 = new THREE.Vector3(xMin, yMax, Z_COORD_BOX);
        const vb3 = new THREE.Vector3(xMax, yMax, Z_COORD_BOX);
        ...
        const boxTriangle = new THREE.Triangle(vb0, vb1, vb2);
        const boxNormal = boxTriangle.normal();
        // eslint-disable-next-line
