...
export default class Graphics2d {
  ...
  */
  constructor(container, width, height) {
    ...
    this.m_levelSetCenterCircle = null;
  ...
  */
  ...
  drawLevelSetCenter(x, y) {
    this.m_levelSetCenterPoint = { 'x': x, 'y': y };
    ...
    const xS = (x - xRadius - this.m_posX) / this.m_zoom - (1 - 1 / this.m_zoom);
    const yS = (y - yRadius - this.m_posY) / this.m_zoom + (1 - 1 / this.m_zoom);
    const xE = (x + xRadius - this.m_posX) / this.m_zoom - (1 - 1 / this.m_zoom);
    const yE = (y + yRadius - this.m_posY) / this.m_zoom + (1 - 1 / this.m_zoom);
    const lineBottom = new Line2D(this.m_scene, this.m_lineWidth, xS, yS, xE, yS, this.m_linesMaterial);
    const lineLeft = new Line2D(this.m_scene, this.m_lineWidth, xS, yS, xS, yE, this.m_linesMaterial);
    const lineTop = new Line2D(this.m_scene, this.m_lineWidth, xS, yE, xE, yE, this.m_linesMaterial);
    const lineRight = new Line2D(this.m_scene, this.m_lineWidth, xE, yS, xE, yE, this.m_linesMaterial);
    this.m_levelSetCenterCircle = {
      'left': lineLeft,
      'top': lineTop,
      'right': lineRight,
      'bottom': lineBottom,
  ...
  drawLevelSetCircle(radius) {
    ...
    const xS = (this.m_levelSetCenterPoint.x - xRadius - this.m_posX) / this.m_zoom - (1 - 1 / this.m_zoom);
    const yS = (this.m_levelSetCenterPoint.y - yRadius - this.m_posY) / this.m_zoom + (1 - 1 / this.m_zoom);
    const xE = (this.m_levelSetCenterPoint.x + xRadius - this.m_posX) / this.m_zoom - (1 - 1 / this.m_zoom);
    const yE = (this.m_levelSetCenterPoint.y + yRadius - this.m_posY) / this.m_zoom + (1 - 1 / this.m_zoom);
    const lineBottom = new Line2D(this.m_scene, this.m_lineWidth, xS, yS, xE, yS, this.m_linesMaterial);
    const lineLeft = new Line2D(this.m_scene, this.m_lineWidth, xS, yS, xS, yE, this.m_linesMaterial);
    const lineTop = new Line2D(this.m_scene, this.m_lineWidth, xS, yE, xE, yE, this.m_linesMaterial);
    const lineRight = new Line2D(this.m_scene, this.m_lineWidth, xE, yS, xE, yE, this.m_linesMaterial);
    this.m_levelSetCircle = {
      'left': lineLeft,
      'top': lineTop,
      'right': lineRight,
      'bottom': lineBottom,
   ...
   */
  clearLevelSetCenter() {
    if (this.m_levelSetCenterCircle !== null) {
      this.m_scene.remove(this.m_levelSetCenterCircle.left.getRenderObject());
      this.m_scene.remove(this.m_levelSetCenterCircle.top.getRenderObject());
      this.m_scene.remove(this.m_levelSetCenterCircle.right.getRenderObject());
      this.m_scene.remove(this.m_levelSetCenterCircle.bottom.getRenderObject());
      this.m_levelSetCenterCircle = null;
      this.m_levelSetCenterPoint = null;
    }
  }
  ...
  clearLevelSetCircle() {
    if (this.m_levelSetCircle !== null) {
      this.m_scene.remove(this.m_levelSetCircle.left.getRenderObject());
      this.m_scene.remove(this.m_levelSetCircle.top.getRenderObject());
      this.m_scene.remove(this.m_levelSetCircle.right.getRenderObject());
      this.m_scene.remove(this.m_levelSetCircle.bottom.getRenderObject());
      this.m_levelSetCircle = null;
    }
  }
