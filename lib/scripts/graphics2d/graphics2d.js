...
export default class Graphics2d {
  ...
  */
  onMouseDown(xScr, yScr) {
    ...
    switch (this.m_toolType) {
      ...
      case tools2d.ZOOM:
        ...
        break;
      case tools2d.DELETE: // TO DO: add text tool
        this.m_deleteTool.onMouseDown(xt, yt, this.m_distanceTool.m_distances, this.m_angleTool.m_angles,
          this.m_rectTool.m_areas, this.m_areaTool.m_distances, this.m_distanceTool.m_vertexes,
          this.m_angleTool.m_vertexes, this.m_rectTool.m_vertexes, this.m_areaTool.m_vertexes2,
          this.m_areaTool.m_last_lengths, this.m_areaTool.m_vertexes, this.m_areaTool);
    ...
    switch (this.m_toolType) {
      ...
      case tools2d.DELETE: // TO DO: add text tool
        this.m_deleteTool.onMouseMove(xt, yt, this.m_zoom, this.m_distanceTool.m_distances, this.m_angleTool.m_angles,
          this.m_rectTool.m_areas, this.m_areaTool.m_distances);
        break;
      case tools2d.EDIT: // TO DO: add text tool
        this.m_editTool.onMouseMove(xt, yt, this.m_zoom, this.m_distanceTool.m_distances, this.m_angleTool.m_angles,
          this.m_rectTool.m_areas, this.m_areaTool.m_distances, this.m_areaTool, this.m_posX * (this.m_wProjScreen),
          this.m_posY * (this.m_hProjScreen));
  ...
  updateLines() {
    ...
    this.m_textTool.update(this.m_zoom, this.m_posX * this.m_wProjScreen, this.m_posY * this.m_hProjScreen);
