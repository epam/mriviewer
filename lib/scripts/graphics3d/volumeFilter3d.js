  ...
  */
  ...
  setVolumeTextureWebGL2(blurSigma) {
    ...
    for (let z = 0; z < this.zDim; ++z) {
      this.material.uniforms.curZ.value = z / (this.zDim - 1.0);
      this.material.uniforms.curZ.needsUpdate = true;
  ...
  setAmbientTexture() {
    ...
    this.vectors = new Uint8Array(VAL_4 * numVertices);
    ...
    this.vectorsTex = new THREE.DataTexture(this.vectors, numVertices, 1, THREE.RGBAFormat);
    ...
    matAO.create(this.origVolumeTex, texelSize, this.vectorsTex, numVertices, (mat) => {
      this.materialAO = mat;
