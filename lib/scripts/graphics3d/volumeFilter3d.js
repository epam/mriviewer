...
import { tools3d } from '../../../app/scripts/menu';
...
export default class VolumeFilter3d {
  ...
  erasePixelsFloodFill(x_, y_, z_, startflag, mouseup) {
    ...
    console.log(`Target: ${targetX}, ${targetY}, ${targetZ}`);
    this.lastMode.push(tools3d.FILL);
  ...
  undoLastErasing() {
    if (this.lastMode.pop() === tools3d.FILL) {
