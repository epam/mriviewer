...
//                    console.log(`updateTransferFuncTextureF: ${intensities.length}`);
...
//                console.log(`updateTransferFuncTextureF: ${pixStart}, ${pixEnd}, ${opacities[curPt]}, ${opacities[curPt + 1]}`);
...
//                    console.log(`color: ${color.x}, ${color.y}, ${color.z}, ${this.transferFuncRgba[pix * 4 + 3]}`);
      }
    }
