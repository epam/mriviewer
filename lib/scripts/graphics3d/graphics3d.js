...
export default class Graphics3d {
  ...
  */
  ...
  addSphereToSphereSceneWireFrame() {
    ...
    const matThreeJs = matWCloader.create();
    ...
    this.meshSphereWireFrame = new THREE.Mesh(this.geometryWireFrameSphere, matThreeJs);
  ...
  render() {
    ...
    if (!matReady) {
      ...
      if (this.renderScene === SCENE_TYPE_SPHERE) {
        ...
        gl.stencilFunc(gl.ALWAYS, 1, FF_VAL);
        gl.stencilOp(gl.REPLACE, gl.REPLACE, gl.REPLACE);
        this.sceneSphere.overrideMaterial = this.matInterpolation;
