...
export default class Graphics3d {
  ...
  */
  callbackCreateCubeVolumeBF(window, box, nonEmptyBoxMin, nonEmptyBoxMax, isRoiVolume = false) {
    ...
    this.texRoiId = this.volumeUpdater.texRoiId;
    this.texRoiColor = this.volumeUpdater.texRoiColor;
    this.RoiVolumeTex = this.volumeUpdater.RoiVolumeTex;
    ...
    matRenderToTextureThreeGS.create(this.texTF, this.volTexture, this.texRoiId, this.texRoiColor,
      this.RoiVolumeTex, this.volTextureMask, this.bfTexture, this.ffTexture,
      (mat) => {
    ...
    matSkullThreeGS.create(this.texTF, this.volTexture, this.texRoiId, this.texRoiColor,
      this.RoiVolumeTex, this.volTextureMask, this.bfTexture, this.ffTexture,
      this.renderToTexture, (mat) => {
        mat.uniforms.t_function1min.value =
          new THREE.Vector4(VOLUME_COLOR1_MIN_R, VOLUME_COLOR1_MIN_G, VOLUME_COLOR1_MIN_B,
            this.curFileDataType.thresholdTissue1);
        mat.uniforms.t_function1max.value =
  ...
  */
  ...
  onMouseDown(xx, yy, ctrlKey) {
    ...
    if (this.isEraseMode && ctrlKey) {
      ...
      this.volumeUpdater.erasePixels(vX, vY, vZ, this.eraserRadius);
    }
  }
