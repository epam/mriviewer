...
export default class Graphics3d {
  ...
  */
  callbackCreateCubeVolumeBF(window, box, nonEmptyBoxMin, nonEmptyBoxMax, isRoiVolume = false) {
    ...
    matRenderToTextureThreeGS.create(this.texTF, this.volTexture, this.texRoiId, this.texRoiColor, this.RoiVolumeTex, this.volTextureMask, this.bfTexture, this.ffTexture,
      (mat) => {
    ...
    matSkullThreeGS.create(this.texTF, this.volTexture, this.texRoiId, this.texRoiColor, this.RoiVolumeTex, this.volTextureMask, this.bfTexture, this.ffTexture,
