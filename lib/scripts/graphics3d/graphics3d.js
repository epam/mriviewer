...
export default class Graphics3d {
  ...
  */
  ...
  setStepsize(sliderValue) {
    this.matRenderToTexture.uniforms.stepSize.value = new THREE.Vector4
    (1.0 / sliderValue, 1.0 / sliderValue, 2.0 / sliderValue, 1.0 / sliderValue);
    this.matRenderToTexture.uniforms.needsUpdate = true;
    this.matVolumeRender.uniforms.stepSize.value = new THREE.Vector4
    (1.0 / sliderValue, 1.0 / sliderValue, 1.0 / sliderValue, 1.0 / sliderValue);
