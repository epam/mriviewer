...
export default class Graphics3d {
  ...
  constructor(engine2d, root3dContainer, curFileDataType) {
    ...
    // this.sceneSphereWireFrame = new THREE.Scene();
    this.meshSphere = null;
    // this.meshSphereWireFrame = null;
    this.isSphereScenes = false;
  ...
  */
  ...
  //}
  addSphereToSphereSceneWireFrame() {
    //const matThreeJs = new THREE.MeshBasicMaterial({
    //  color: 0xFFFF0077, depthTest: true,
    //  wireframe: true,
    ...
    //// old style: create buffer geometry
    //this.geometryWireFrameSphere = new THREE.BufferGeometry();
    //this.geometryWireFrameSphere.fromGeometry(geo);
    ////this.geometryWireFrameSphere = new THREE.SphereGeometry( 0.5, 10, 10 );

    //// this.geometryWireFrameSphere = geo;

    //this.meshSphereWireFrame = new THREE.Mesh(this.geometryWireFrameSphere, this.matWireFrame);
    //this.sceneSphereWireFrame.add(this.meshSphereWireFrame);
    //return this.meshSphereWireFrame;
  }
  ...
  */
  ...
  callbackCreateCubeVolumeBF(window, box, nonEmptyBoxMin, nonEmptyBoxMax, isRoiVolume = false) {
    ...
    if (this.isSphereScenes === false) {
      this.addSphereToSphereSceneWireFrame();
      this.addSphereToSphereScene();
      this.isSphereScenes = true;
    }
    this.renderScene = SCENE_TYPE_RAYCAST;
    this.sceneReadyCounter = 0;
    this.renderCounter = 0;
  ...
  */
  ...
  onMouseMove(xx, yy, ctrlKey) {
    ...
    if (this.isSculptingMode && ctrlKey && !this.mouseupflag) {
      ...
      const MUL = 0.001;
      vVertexNormal.normalize().multiplyScalar(rDelta * MUL * this.sculptingSphereSize);
