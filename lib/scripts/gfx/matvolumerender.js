...
export default class MaterialVolumeRender {
  ...
  */
  create(texTF, texVol2d, texRoiId, texRoiColor, RoiVolumeTex, texVolMask, texBackface, texFrontface, renderTexture, callbackMat) {
    // Init uniforms
    this.m_uniforms.texTF.value = texTF;
    this.m_uniforms.texVolume.value = texVol2d;
    this.m_uniforms.texRoiId.value = texRoiId;
    this.m_uniforms.texRoiColor.value = texRoiColor;
    this.m_uniforms.RoiVolumeTex.value = RoiVolumeTex;
