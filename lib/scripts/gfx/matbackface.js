...
* @module app/scripts/fgx/shaders/matbackface
*/
...
const BACK_FACE_VERTEX_SHADER = './shaders/backface_vert.glsl';
const BACK_FACE_FRAGMENT_SHADER = './shaders/backface_frag.glsl';
