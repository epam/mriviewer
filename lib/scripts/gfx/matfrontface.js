...
* @module app/scripts/fgx/shaders/matfrontface
*/
...
const FRONT_FACE_VERTEX_SHADER = './shaders/frontface_vert.glsl';
const FRONT_FACE_FRAGMENT_SHADER = './shaders/frontface_frag.glsl';
